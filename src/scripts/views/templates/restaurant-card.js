import { RestoRestAPI } from '../../data/GithubRestAPI'; // Assuming this is where your API helper is located
...
export const RestaurantCardTemplate = {
  create: (restaurant) => {
    ...
    restaurantCard.innerHTML = `
        <img src="${RestoRestAPI.getImageUrl(restaurant.pictureId, 'medium')}" 
